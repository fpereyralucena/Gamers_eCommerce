-- users --
INSERT INTO gamercostumes.users (id, firstName, lastName, password, email, userEspecify_id, image) VALUES
(1, "Admin", "Admin", "QWERTY", "admin@gamerscostumes.com", "default-Image.jpg")
...
(1, "Mortal Kombat 2", 10000, 10, "mortalKombat.jpg"),
